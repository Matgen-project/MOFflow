...
if __name__ == '__main__':
    ...
    print(jsondata)
    #with open("/WORK/nscc-gz_material_1/MOFs/script/calc_result_data/result_Adsorption_" + molecule,"a+") as adsfile:
    #    json.dump(result_list, adsfile, sort_keys=False, indent=4, separators=(',', ':'))
